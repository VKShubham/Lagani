...
public class RecyclerViewForHistory2 extends RecyclerView.Adapter<RecyclerViewForHistory2.ViewHolder> {

    private Context context;
    private List<Donations> list;

    public RecyclerViewForHistory2(Context context, List<Donations> list) {
